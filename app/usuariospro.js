...
export default function Usuarios() {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        console.log('Usuarios:', res.data); // Ver los datos completos de los usuarios
  ...
  const usuariosFiltrados = usuarios
    .filter((u) => {
      // Verificamos que plan sea 'pro', usando `toLowerCase()` y `trim()`
      const plan = u.plan?.toLowerCase()?.trim();
      console.log('Plan:', plan); // Para verificar los valores del plan
      return plan === 'pro' && `${u.nombre} ${u.apellido}`.toLowerCase().includes(busqueda.toLowerCase());
    })
    .sort((a, b) => {
...
>
  ...
  <Text style={styles.dashboardText}>Dashboard</Text>
      ...
      <Text style={styles.title}>Usuarios (Plan Pro)</Text>
      ...
      <View style={styles.ordenadoContainer}>
        ...
        >
          <Text
            style={[styles.filtroText, filtro === 'A-Z' && styles.filtroTextActivo]}
          >
            A-Z
          </Text>
        </TouchableOpacity>
        ...
        >
          <Text
            style={[styles.filtroText, filtro === 'Tipo' && styles.filtroTextActivo]}
          >
            Tipo
          </Text>
        </TouchableOpacity>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>No hay usuarios 'Pro' para mostrar</Text>
          </View>
        }
      />
